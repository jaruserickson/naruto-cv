""" NOTE
the only modification made to this file was the switch to
tf.keras from native keras.
source: https://github.com/fizyr/keras-retinanet/blob/master/keras_retinanet/losses.py
"""
